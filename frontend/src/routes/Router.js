...
const ExamResults = Loadable(lazy(() => import('./../views/teacher/ExamResults')));
    ...
    <>
      ...
      <Route path="" element={<PrivateRoute />}>
        ...
        <Route path="/" element={<FullLayout />}>
          ...
          <Route path="/my-results" exact={true} element={<StudentResults />} />
          <Route path="" element={<TeacherRoute />}>
            ...
            <Route path="/exam-results/:examId" exact={true} element={<ExamResults />} />
          </Route>
        </Route>
